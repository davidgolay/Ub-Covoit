...
<div id="page">
    ...
    <div id=général>En vigueur au 28/12/2020</div>
    <br>
    <p>Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique des modalités de mise à disposition du site et des services par Ub’Covoit et de définir les conditions d’accès et d’utilisation des services par « l'Utilisateur ».</p>
    ...
    <p>Ub'Covoit se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes CGU.</p>


    <h2>Article 1 : Les mentions légales</h2>


    <p>L'édition du site d'Ub'Covoit est assurée par la Société (fictive) EURL Ub’Covoit, dont le siège social est situé au Boulevard Docteur Petitjean, 21000 Dijon (IUT Informatique - Dijon)</p>
    <p>Numéro de téléphone  <a href="tel:+33380396550">03 80 39 65 50</a></p>
    <p>Adresse e-mail : <a href=mailto:David_Golay@etu.u-bourgogne.fr>David_Golay@etu.u-bourgogne.fr</a>.</p>
    <p>Le Directeur de la publication est : Golay David</p>
    <p>L'adresse du site internet d'Ub'Covoit est : <a href=http://grp-366.iq.iut21.u-bourgogne.fr/siteub/page/login.php>http://grp-366.iq.iut21.u-bourgogne.fr/siteub/page/login.php</a></p>
    ...
    <p>Le site d'Ub'Covoit permet à l'Utilisateur un accès gratuit aux services suivants :</p>
    <p>Le site internet propose les services suivants :</p>
    <p>Communiquer, échanger et fixer des trajets de covoiturage entre les membres.</p>
    ...
    <p>Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du site ou serveur et sous réserve de toute interruption ou modification en cas de maintenance, n'engage pas la responsabilité de d'Ub'Covoit. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à l’éditeur de toute interruption ou suspension de service, même sans préavis.</p>
    ...
    <p>Le site assure à l'Utilisateur une collecte et un traitement d'informations personnelles dans le respect de la vie privée conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés. Le site est déclaré à la CNIL sous le numéro 000000.</p>
    ...
    <p>Les sources des informations diffusées sur le site d'Ub'Covoit sont réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.</p>
    <p>Les informations communiquées sont présentées à titre indicatif et général sans valeur contractuelle. Malgré des mises à jour régulières, le site d'Ub'Covoit ne peut être tenu responsable de la modification des dispositions administratives et juridiques survenant après la publication. De même, le site ne peut être tenue responsable de l’utilisation et de l’interprétation de l’information contenue dans ce site.</p>
    <br>
    ...
    <br>
    <p>En cas de proposition de trajet, la responsabilité de l’Utilisateur de posséder un permis de conduire contenant au minimum un point et une carte d’identité aux normes lui appartient, la plateforme ne pourra vérifier. </p>
    <br>
    <p>Ub’Covoit ne sera pas tenu responsable des dérives des utilisateurs, pour cela, nous donnerons un fort degré de responsabilité à nos utilisateurs. Toutefois, Ub’Covoit pourrait éventuellement apporter un système de liste noire des utilisateurs malveillants. </p>
    <br>
    <p>Le site  ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de ce site.</p>
    ...
    <p>Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces liens, il sortira du site d'Ub'Covoit. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.</p>
    
    
    <h2>ARTICLE 7 : Cookies</h2>


    <p>La plateforme Ub’Covoit n’utilise actuellement aucun cookie, cependant elle réserve la possibilité de faire appel à des cookies dans un futur proche. </p>
    ...
    <p>Les cookies sont de petits fichiers stockés temporairement sur le disque dur de l’ordinateur de l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site d'Ub'Covoit. Les cookies ne contiennent pas d’information personnelle et ne peuvent pas être utilisés pour identifier quelqu’un. Un cookie contient un identifiant unique, généré aléatoirement et donc anonyme. Certains cookies expirent à la fin de la visite de l’Utilisateur, d’autres restent.</p>
    <p> L’information contenue dans les cookies est utilisée pour améliorer le site d'Ub'Covoit.</p>
    ...
    <p> Des rendez-vous entre plusieurs utilisateurs..</p>
